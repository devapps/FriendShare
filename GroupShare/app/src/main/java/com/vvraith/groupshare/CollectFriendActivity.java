...
public class CollectFriendActivity extends AppCompatActivity implements MyAppActivity {
    ...
    private static final String TAG = "CollectFriendActivity";
    ProgressDialog progressDialog = null;
    private static final int REQUEST_SIGNUP = 0;
    String requestUrl = "/api/collectmoney/friend?";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collect_friend);
        ButterKnife.bind(this);
        TransactionId_upi = String.valueOf(new Random().nextInt(99999999));
        progressDialog = new ProgressDialog(CollectFriendActivity.this,
                R.style.AppThemeDarkDialog);

        extras = getIntent().getExtras();
        _fromnameText.setText(extras.getString("friendname"));
        _fromvirtualidText.setText(extras.getString("friendvirtualid"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_collect_friend, menu);
        return true;
    }
